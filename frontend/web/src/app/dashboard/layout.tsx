 ...
 *
 * Access is restricted to staff roles (admin / owner / coach). Fine-grained
 * section-level gates (e.g. admin-only Users/Roles/Permissions) are handled
 * inside their individual pages.
 */
export default function DashboardLayout({
  ...
  return (
    <AuthGuard roles={["admin", "owner", "coach"]}>
